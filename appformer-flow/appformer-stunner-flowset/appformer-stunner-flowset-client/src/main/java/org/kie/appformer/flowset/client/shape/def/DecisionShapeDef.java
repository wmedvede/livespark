...
public class DecisionShapeDef
    ...
    public SVGShapeView<?> newViewInstance(final FlowSVGViewFactory factory,
        ...
        return factory.decision(getWidth(gateway),
                                getHeight(gateway),
                                false);
    }
    ...
    private static final PictureGlyphDef<BaseGateway, FlowPictures> GLYPH_DEF = new PictureGlyphDef<BaseGateway, FlowPictures>() {
        ...
        public FlowPictures getSource(final Class<?> type) {
            return FlowPictures.DECISION_ICON;
        }
    };
